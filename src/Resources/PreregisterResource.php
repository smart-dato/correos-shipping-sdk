...
class PreregisterResource
{
    ...
    {
        return $this->connector->send(new GetPackagesByReferenceRequest($clientReference, $contractNumber, $clientNumber))->dtoOrFail();
    }

    public function searchLabelsInfo(SearchLabelsInfoRequestData $data): LabelsInfoResponseData
    {
        return $this->connector->send(new SearchLabelsInfoRequest($data))->dtoOrFail();
    }

    public function getBackofficeShipment(string $shipmentCode): BackofficeResponseData
    {
        return $this->connector->send(new GetBackofficeShipmentRequest($shipmentCode))->dtoOrFail();
    }
    ...
    {
        return $this->connector->send(new GetBackofficeErrorsRequest($contractNumber, $clientNumber, $dateFrom, $dateTo))->dtoOrFail();
    }
    ...
    {
        return $this->connector->send(new GetBackofficeTotalRequest($contractNumber, $clientNumber, $dateFrom, $dateTo))->dtoOrFail();
    }
    ...
    {
        return $this->connector->send(new GetBackofficeWaitingRequest($contractNumber, $clientNumber, $dateFrom, $dateTo))->dtoOrFail();
    }
}
