...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/correos-shipping-sdk.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/correos-shipping-sdk)
...
```bash
php artisan vendor:publish --tag="correos-shipping-sdk-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="correos-shipping-sdk-views"
```

## Usage

```php
$correosShipping = new SmartDato\CorreosShipping();
echo $correosShipping->echoPhrase('Hello, SmartDato!');
```
